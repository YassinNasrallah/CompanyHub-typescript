           ...
           <h2 className="font-semibold text-xl">Company Information</h2>
            <div className="flex justify-center items-center text-gray-800 p-0.5 gap-1 border border-gray-400">
               ...
               <div className="flex justify-between">
                   ...
                   <p className="text-gray-900 text-sm font-medium text-right">{DashboardData.company.name}</p>
               </div>
               <div className="border border-gray-100"></div>
               <div className="flex justify-between">
                   <h2 className="text-gray-600 font-medium">VAT Number</h2>
                   <p className="text-gray-900 text-sm font-medium text-right">{DashboardData.company.vatNumber}</p>
               </div>
               <div className="border border-gray-100"></div>
               <div className="flex justify-between">
                   <h2 className="text-gray-600 font-medium">Register Address</h2>
                   <p className="text-gray-900 text-sm font-medium text-right">{DashboardData.company.address}</p>
               </div>
               <div className="border border-gray-100"></div>
               <div className="flex justify-between">
                   <h2 className="text-gray-600 font-medium">Phone Number</h2>
                   <p className="text-gray-900 text-sm font-medium text-right ">{DashboardData.company.phone}</p>
               </div>
               <div className="border border-gray-100"></div>
               <div className="flex justify-between">
                   <h2 className="text-gray-600 font-medium">Website</h2>
                   <p className="text-gray-900 text-sm font-medium text-right">{DashboardData.company.website}</p>
               </div>
           </div>
     </div>  
